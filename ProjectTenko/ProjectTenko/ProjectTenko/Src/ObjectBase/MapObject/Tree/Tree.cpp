...
Tree::Tree(D3DXVECTOR3 pos_, std::string key_, std::vector<MapObjectData> mapObjcectList_):
	MapObject(pos_, key_, mapObjcectList_)
{
	THE_FBXMANAGER->LoadFBXMesh(m_FbxKey, "assets/objects/tree/wood_01.fbx");
}
