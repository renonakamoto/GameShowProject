...
TitleUI::TitleUI()
{
	...
	m_TitleUIList[TITLE_UI_LIST::TITLE_UI_START]   = UI_PARAMETER(D3DXVECTOR2(704.0f, 640.f), 512.f,  64.f,  "assets/UI/title/title02.png");
	m_TitleUIList[TITLE_UI_LIST::TITLE_UI_SETTING] = UI_PARAMETER(D3DXVECTOR2(704.0f, 740.f), 512.f,  64.f,  "assets/UI/title/title04.png");
	m_TitleUIList[TITLE_UI_LIST::TITLE_UI_EXIT]    = UI_PARAMETER(D3DXVECTOR2(704.0f, 840.f), 512.f,  64.f,  "assets/UI/title/title05.png");
